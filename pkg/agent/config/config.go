...
func locateOrGenerateResolvConf(envInfo *cmds.Agent) string {
	...
	logrus.Warnf("Host resolv.conf includes loopback, multicast, or link-local nameservers - kubelet will use autogenerated resolv.conf with nameservers 1.2.4.8 2001:4860:4860::8888")
	return resolvConf
}
