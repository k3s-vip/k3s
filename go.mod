...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.5-k29vip
	...
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.35-k29vip
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.28.9-vip
	github.com/google/cadvisor => github.com/google/cadvisor v0.54.1
	github.com/google/cel-go => github.com/google/cel-go v0.17.8
	github.com/k3s-io/kine => github.com/k3s-vip/kine v0.16.4-downgrade4
...
require (
	...
	github.com/containerd/containerd/api v1.8.0 // replace
