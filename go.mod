...
replace (
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.1-k32vip0
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.6.3-vip
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.6-vip
	...
	github.com/opencontainers/runc => github.com/k3s-vip/runc v1.3.4-vip0
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.6.4-vip0
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.6.0-vip8
	go.etcd.io/etcd/api/v3 => github.com/k3s-vip/etcd/api/v3 v3.6.7-vip
	go.etcd.io/etcd/client/pkg/v3 => github.com/k3s-vip/etcd/client/pkg/v3 v3.6.7-vip
	go.etcd.io/etcd/client/v3 => github.com/k3s-vip/etcd/client/v3 v3.6.7-vip
	go.etcd.io/etcd/etcdutl/v3 => github.com/k3s-vip/etcd/etcdutl/v3 v3.6.7-vip
	go.etcd.io/etcd/pkg/v3 => github.com/k3s-vip/etcd/pkg/v3 v3.6.7-vip
	go.etcd.io/etcd/server/v3 => github.com/k3s-vip/etcd/server/v3 v3.6.7-vip
	...
	k8s.io/api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/api v1.32.12-vip
	k8s.io/apiextensions-apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/apiextensions-apiserver v1.32.12-vip
	k8s.io/apimachinery => github.com/k3s-vip/kubernetes/staging/src/k8s.io/apimachinery v1.32.12-vip
	k8s.io/apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/apiserver v1.32.12-vip
	k8s.io/cli-runtime => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cli-runtime v1.32.12-vip
	k8s.io/client-go => github.com/k3s-vip/kubernetes/staging/src/k8s.io/client-go v1.32.12-vip
	k8s.io/cloud-provider => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cloud-provider v1.32.12-vip
	k8s.io/cluster-bootstrap => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cluster-bootstrap v1.32.12-vip
	k8s.io/code-generator => github.com/k3s-vip/kubernetes/staging/src/k8s.io/code-generator v1.32.12-vip
	k8s.io/component-base => github.com/k3s-vip/kubernetes/staging/src/k8s.io/component-base v1.32.12-vip
	k8s.io/component-helpers => github.com/k3s-vip/kubernetes/staging/src/k8s.io/component-helpers v1.32.12-vip
	k8s.io/controller-manager => github.com/k3s-vip/kubernetes/staging/src/k8s.io/controller-manager v1.32.12-vip
	k8s.io/cri-api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cri-api v1.32.12-vip
	k8s.io/cri-client => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cri-client v1.32.12-vip
	k8s.io/csi-translation-lib => github.com/k3s-vip/kubernetes/staging/src/k8s.io/csi-translation-lib v1.32.12-vip
	k8s.io/dynamic-resource-allocation => github.com/k3s-vip/kubernetes/staging/src/k8s.io/dynamic-resource-allocation v1.32.12-vip
	k8s.io/endpointslice => github.com/k3s-vip/kubernetes/staging/src/k8s.io/endpointslice v1.32.12-vip
	k8s.io/externaljwt => github.com/k3s-vip/kubernetes/staging/src/k8s.io/externaljwt v1.32.12-vip
	k8s.io/klog/v2 => github.com/k3s-vip/klog/v2 latest // main
	k8s.io/kms => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kms v1.32.12-vip
	k8s.io/kube-aggregator => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-aggregator v1.32.12-vip
	k8s.io/kube-controller-manager => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-controller-manager v1.32.12-vip
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20250701173324-9bd5c66d9911
	k8s.io/kube-proxy => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-proxy v1.32.12-vip
	k8s.io/kube-scheduler => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-scheduler v1.32.12-vip
	k8s.io/kubectl => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kubectl v1.32.12-vip
	k8s.io/kubelet => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kubelet v1.32.12-vip
	k8s.io/kubernetes => github.com/k3s-vip/kubernetes v1.32.12-vip
	k8s.io/metrics => github.com/k3s-vip/kubernetes/staging/src/k8s.io/metrics v1.32.12-vip
	k8s.io/mount-utils => github.com/k3s-vip/kubernetes/staging/src/k8s.io/mount-utils v1.32.12-vip
	k8s.io/node-api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/node-api v1.32.12-vip
	k8s.io/pod-security-admission => github.com/k3s-vip/kubernetes/staging/src/k8s.io/pod-security-admission v1.32.12-vip
	k8s.io/sample-apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-apiserver v1.32.12-vip
	k8s.io/sample-cli-plugin => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.32.12-vip
	k8s.io/sample-controller => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-controller v1.32.12-vip
	sigs.k8s.io/cri-tools => github.com/k3s-vip/cri-tools v1.32.12-vip
)
...
require (
	...
	github.com/containerd/cgroups/v3 v3.1.0 // for runtime-spec v1.2.1
	...
	github.com/rootless-containers/rootlesskit/v2 v2.3.6 // stable
	...
	k8s.io/api v0.32.12 // replace
	k8s.io/apimachinery v0.32.12 // replace
	k8s.io/apiserver v0.32.12 // replace
	k8s.io/cli-runtime v0.32.12 // replace
	k8s.io/client-go v0.32.12 // replace
	k8s.io/cloud-provider v0.32.12 // replace
	k8s.io/cluster-bootstrap v0.32.12 // replace
	k8s.io/component-base v0.32.12 // replace
	k8s.io/component-helpers v0.32.12 // replace
	k8s.io/cri-api v0.32.12 // replace
	k8s.io/cri-client v0.32.12 // replace
	k8s.io/klog/v2 latest // replace
	k8s.io/kube-proxy v0.32.12 // replace
	k8s.io/kubectl v0.32.12 // replace
	k8s.io/kubelet v0.32.12 // replace
	k8s.io/kubernetes v1.32.12 // replace
...
require (
	...
	github.com/go-ini/ini v1.67.0 // latest
	...
	k8s.io/apiextensions-apiserver v0.32.12 // replace
	k8s.io/code-generator v0.32.12 // replace
	k8s.io/controller-manager v0.32.12 // replace
	k8s.io/csi-translation-lib v0.32.12 // replace
	k8s.io/dynamic-resource-allocation v0.32.12 // replace
	k8s.io/endpointslice v0.32.12 // replace
	k8s.io/externaljwt v0.32.12 // replace
	k8s.io/gengo latest // stable
	k8s.io/gengo/v2 latest // stable
	k8s.io/kms v0.32.12 // replace
	k8s.io/kube-aggregator v0.32.12 // replace
	k8s.io/kube-controller-manager v0.32.12 // replace
	k8s.io/kube-openapi v0.0.0-20250318190949-c8a335a9a2ff // replace
	k8s.io/kube-scheduler v0.32.12 // replace
	k8s.io/metrics v0.32.12 // replace
	k8s.io/mount-utils v0.32.12 // replace
	k8s.io/pod-security-admission v0.32.12 // replace
