...
replace (
	...
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.2.0-vip6281153
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.32.4-k3s1
	...
	k8s.io/sample-cli-plugin => github.com/k3s-io/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.32.4-k3s1
	k8s.io/sample-controller => github.com/k3s-io/kubernetes/staging/src/k8s.io/sample-controller v1.32.4-k3s1
	sigs.k8s.io/cri-tools => github.com/k3s-vip/cri-tools v1.32.4-vip
)
