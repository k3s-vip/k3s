...
replace (
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.7.1-vip
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.4.0-vip6551762
