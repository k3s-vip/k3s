...
replace (
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.5-k32vip
	...
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.9-k32vip
...
require (
	...
	github.com/containerd/cgroups/v3 latest // replace
	github.com/containerd/containerd/api v1.9.0 // replace
	...
	github.com/containerd/stargz-snapshotter v0.18.1 // replace
