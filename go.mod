...
replace (
	...
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.4-vip
	...
	github.com/opencontainers/runc => github.com/k3s-vip/runc v1.3.0-vip32526711
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.7.0-vip1183314
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.3.0-vip8610444
	...
	sigs.k8s.io/cri-tools => github.com/k3s-vip/cri-tools v1.32.7-vip
)
