...
replace (
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.28.8-vip
	github.com/google/cadvisor => github.com/google/cadvisor v0.54.1
	github.com/google/cel-go => github.com/google/cel-go v0.17.8
	github.com/k3s-io/kine => github.com/k3s-vip/kine v0.16.3-downgrade
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.9.0-downgrade1
