...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.4-k29
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.11.1-vip1
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.34-upgrade
	...
	github.com/k3s-io/kine => github.com/k3s-vip/kine v0.16.4-downgrade1
...
require (
	...
	github.com/cyphar/filepath-securejoin v0.5.2 // stable
