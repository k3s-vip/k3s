...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.3-k26
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.10.0-vip1
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.33-vip1
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.28.5-downgrade
