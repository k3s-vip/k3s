...
replace (
	...
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.31-upgrade1
	...
	github.com/k3s-io/kine => github.com/k3s-vip/kine v0.14.16-downgrade
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.8.1-downgrade
	github.com/rancher/wrangler => github.com/rancher/wrangler v1.1.1-0.20230818201331-3604a6be798d
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.7.0-downgrade4
...
require (
	...
	github.com/containerd/containerd/api v1.8.0 // for containerd v1.x
	...
	github.com/go-ini/ini v1.66.6 // latest
