...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.6-k26vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.11.1-vip2
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.34-k26
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.28.9-downgrade
