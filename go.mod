...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.6-k29vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.11.1-vip2
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.34-k29
	...
	github.com/k3s-io/kine => github.com/k3s-vip/kine v0.16.4-downgrade2
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.9.1-downgrade
...
require (
	...
	github.com/containerd/containerd/api v1.8.0 // containerd v1.x
