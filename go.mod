...
replace (
	...
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.9.0-vip
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.7-vip1
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.8.1-vip
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.7.0-vip4
...
require (
	...
	github.com/containerd/containerd/api v1.9.0 // for containerd v2.1
...
require (
	...
	github.com/docker/go-connections v0.6.0 // latest sockets.DialPipe
	...
	tags.cncf.io/container-device-interface v1.0.1 // for runtime-spec v1.2.1
	tags.cncf.io/container-device-interface/specs-go v1.0.0 // for runtime-spec v1.2.1
)
