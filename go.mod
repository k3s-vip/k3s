...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.34.7-k3s1
	...
	k8s.io/sample-cli-plugin => github.com/k3s-io/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.34.7-k3s1
	k8s.io/sample-controller => github.com/k3s-io/kubernetes/staging/src/k8s.io/sample-controller v1.34.7-k3s1
...
require (
	...
	k8s.io/cri-client v0.34.7
	k8s.io/klog/v2 v2.140.0
	k8s.io/kube-proxy v0.34.7
...
require (
	...
	k8s.io/csi-translation-lib v0.34.7 // indirect
	k8s.io/dynamic-resource-allocation v0.34.7 // indirect
	k8s.io/endpointslice v0.34.7 // indirect
	k8s.io/externaljwt v1.32.0 // indirect
	k8s.io/kms v0.34.7 // indirect
	k8s.io/kube-aggregator v0.34.7 // indirect
	k8s.io/kube-controller-manager v0.34.7 // indirect
	k8s.io/kube-openapi v0.0.0-20250910181357-589584f1c912 // indirect
	k8s.io/kube-scheduler v0.34.7 // indirect
	k8s.io/metrics v0.34.7 // indirect
	k8s.io/mount-utils v0.34.7 // indirect
	k8s.io/pod-security-admission v0.34.7 // indirect
