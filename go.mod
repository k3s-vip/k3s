...
replace (
	...
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.1-vip
	github.com/distribution/reference => github.com/distribution/reference v0.5.0
	github.com/docker/docker => github.com/docker/docker v27.5.1+incompatible
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.27.0-vip
	github.com/google/cel-go => github.com/google/cel-go v0.22.1
	github.com/opencontainers/runc => github.com/k3s-vip/runc v1.3.0-vip53232266
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.6.2-vip
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.3.0-vip
	go.etcd.io/etcd/api/v3 => github.com/k3s-vip/etcd/api/v3 v3.6.0-vip
	go.etcd.io/etcd/client/pkg/v3 => github.com/k3s-vip/etcd/client/pkg/v3 v3.6.0-vip
	go.etcd.io/etcd/client/v3 => github.com/k3s-vip/etcd/client/v3 v3.6.0-vip
	go.etcd.io/etcd/etcdutl/v3 => github.com/k3s-vip/etcd/etcdutl/v3 v3.6.0-vip
	go.etcd.io/etcd/pkg/v3 => github.com/k3s-vip/etcd/pkg/v3 v3.6.0-vip
	go.etcd.io/etcd/server/v3 => github.com/k3s-vip/etcd/server/v3 v3.6.0-vip
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc => github.com/k3s-vip/opentelemetry-go-contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.61.0-vip
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.32.5-k3s1
	...
	k8s.io/sample-cli-plugin => github.com/k3s-io/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.32.5-k3s1
	k8s.io/sample-controller => github.com/k3s-io/kubernetes/staging/src/k8s.io/sample-controller v1.32.5-k3s1
	sigs.k8s.io/cri-tools => github.com/k3s-vip/cri-tools v1.32.5-vip
)
