...
replace (
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.0-k34vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.5.0-vip
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.4-vip8855928
	github.com/containerd/nri => github.com/containerd/nri v0.9.0 // #161
	github.com/containerd/stargz-snapshotter => github.com/k3s-vip/stargz-snapshotter v0.17.0-vip
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.7.0-vip0614540
	...
	k8s.io/dynamic-resource-allocation => github.com/k3s-vip/kubernetes/staging/src/k8s.io/dynamic-resource-allocation v1.34.1-vip
	k8s.io/endpointslice => github.com/k3s-vip/kubernetes/staging/src/k8s.io/endpointslice v1.34.1-vip
	k8s.io/externaljwt => github.com/k3s-vip/kubernetes/staging/src/k8s.io/externaljwt v1.34.1-vip
	k8s.io/klog/v2 => github.com/k3s-vip/klog/v2 latest // main
	k8s.io/kms => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kms v1.34.1-vip
	...
	k8s.io/node-api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/node-api v1.34.1-vip
	...
	k8s.io/sample-cli-plugin => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.34.1-vip
	k8s.io/sample-controller => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-controller v1.34.1-vip
	sigs.k8s.io/cri-tools => github.com/k3s-vip/cri-tools v1.34.1-vip
)
...
require (
	...
	go.opentelemetry.io/otel/metric v1.34.1 // indirect
	go.opentelemetry.io/otel/sdk v1.34.1 // indirect
	go.opentelemetry.io/otel/trace v1.34.1 // indirect
