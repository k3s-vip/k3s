...
replace (
	...
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.4-vip8087909
	...
	github.com/opencontainers/runc => github.com/k3s-vip/runc v1.3.0-vip3955586
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.7.0-vip1183314
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.3.0-vip6218391
...
require (
	...
	github.com/rancher/remotedialer v0.5.1-0.20250827012652-e6b68fd83a6b // stable
