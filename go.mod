...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.0-k26vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.5.0-vip
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.28-vip
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.27.3-downgrade
