...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.0-k29vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.5.0-vip
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.28-upgrade
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.27.3-vip
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.7.0-vip0209576
	github.com/rancher/wrangler => github.com/rancher/wrangler v1.1.1-0.20230818201331-3604a6be798d
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.3.0-vip3506289
