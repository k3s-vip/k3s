...
replace (
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.6-k32vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.11.1-vip2
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.9-k32
	...
	github.com/docker/go-connections => github.com/docker/go-connections v0.6.0 // sockets.DialPipedial
