...
replace (
	...
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.6.1-vip
	github.com/containerd/containerd/v2 => github.com/k3s-vip/containerd/v2 v2.1.4-vip3517245
	...
	github.com/opencontainers/runc => github.com/k3s-vip/runc v1.3.2-vip
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.6.3-vip
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.4.0-vip8917485
	go.etcd.io/etcd/api/v3 => github.com/k3s-vip/etcd/api/v3 v3.6.5-vip
	go.etcd.io/etcd/client/pkg/v3 => github.com/k3s-vip/etcd/client/pkg/v3 v3.6.5-vip
	go.etcd.io/etcd/client/v3 => github.com/k3s-vip/etcd/client/v3 v3.6.5-vip
	go.etcd.io/etcd/etcdutl/v3 => github.com/k3s-vip/etcd/etcdutl/v3 v3.6.5-vip
	go.etcd.io/etcd/pkg/v3 => github.com/k3s-vip/etcd/pkg/v3 v3.6.5-vip
	go.etcd.io/etcd/server/v3 => github.com/k3s-vip/etcd/server/v3 v3.6.5-vip
